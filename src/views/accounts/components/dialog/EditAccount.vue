...
import type { UpdateAccountPayload } from '@/views/accounts/types/account'

const form = defineModel<UpdateAccountPayload>('form', { required: true })
  ...
  >
    <div class="w-full max-w-[420px] bg-white rounded-2xl shadow-[0_24px_60px_rgba(15,17,32,0.25)] p-7 pt-6">
      <div class="flex items-center justify-between pb-4 mb-5 border-b border-[#eceef5]">
        <h2 class="text-[1.05rem] text-[#1f2337]">編輯帳號</h2>
        <button
